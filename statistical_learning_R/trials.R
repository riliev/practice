...
# you leave one part of the data for validation (in this case 50%)
# MSE is computed from comparing predicted and observed values in the 
# test set
library(ISLR)
set.seed(1)
...
# this is the same as k-fold cross-validation, where k = sample size
